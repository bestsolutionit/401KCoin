...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000008a8b90d5160ae8bbf90d61f5efd6cf3aadf1c6e9ec9d658ffb4ff8d514e"));
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (0, uint256("0x00000f7582a3e21f4a8e051fc621ff654a0d89dded7e88acfbc8c542d2b62db8"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of
    (0, uint256("0x39a8ed422e0aa203a75748fbd8a3ad6fecf97d6265c680df11bb057581a58901"));
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(
                    ...
                    "KRq1boDDb22Lxpfkcoh2cgRBLfHMFo7nWB",   // first treasury address
                    "KGJt71UUfcNGWM7DqDRBwq5p426dCnGa2p",   // second treasury address
                    "KUNPk9m9D5Ctvx8K6xCRxhCEQfKYiQZ9v7"    // third treasury address
                    );
        ...
        if (regenerate) {
            ...
            if (true && (genesis.GetHash() != hashGenesisBlock)) {
                ...
                // Mainnet --- nonce: 572624 time: 1520801782 hash: 0x000008a8b90d5160ae8bbf90d61f5efd6cf3aadf1c6e9ec9d658ffb4ff8d514e merklehash: 0x5d50731c9be308a0290ef71f5728c19b2bd1febfecfc826068e5f63b61303e76
            ...
            assert(hashGenesisBlock == uint256("0x000008a8b90d5160ae8bbf90d61f5efd6cf3aadf1c6e9ec9d658ffb4ff8d514e"));
            assert(genesis.hashMerkleRoot == uint256("0xa7c47150f79b8c63543a5d361918b3f2d32861f4d1a93791c7d097990d175151"));
        }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 2 * 60; // 401KCoin: 1 day
        nTargetSpacing = 2 * 60;  // 401KCoin: 2 minute
        nLastPOWBlock = 10000;
        nMaturity = 15;
        ...
        genesis = CreateGenesisBlock(
                    ...
                    3,                                   // nVersion
                    treasuryDeposit,                     // genesisReward (treasury deposit)
                    "kMZhaBX6Gkzb4gWQiYwm2n1hTzAgiqxqXD", // first treasury address
                    "kN1UaTJBSUKifogu7J89zB92pYe5EvYkpk", // second treasury address
                    "kEsLp381sowyfAP3JCmqGzaT8BgztNJ6rs"  // third treasury address
                    );
        ...
        if (regenerate) {
            ...
            if (true && (genesis.GetHash() != hashGenesisBlock)) {
                ...
                std::cout << " hash: 0x" << genesis.GetHash().ToString().c_str();
                std::cout << " merklehash: 0x"  << genesis.hashMerkleRoot.ToString().c_str() <<  "\n";
                // Testnet --- nonce: 30344 time: 1520801782 hash: 0x00000f7582a3e21f4a8e051fc621ff654a0d89dded7e88acfbc8c542d2b62db8 merklehash: 0xd3c868e9fdca66ace15ff93f5e5e67a43ee840b83b5806153b843791f2f814da
            }
        } else {
            LogPrintf("Testnet ---\n");
            LogPrintf(" nonce: %u\n", genesis.nNonce);
            ...
            LogPrintf(" hash: 0x%s\n", genesis.GetHash().ToString().c_str());
            LogPrintf(" merklehash: 0x%s\n", genesis.hashMerkleRoot.ToString().c_str());
            assert(hashGenesisBlock == uint256("0x00000f7582a3e21f4a8e051fc621ff654a0d89dded7e88acfbc8c542d2b62db8"));
            assert(genesis.hashMerkleRoot == uint256("0x888530f930c62ebcf63db213cc155c33fb56c418882d3aabef5a506627f013b8"));
        }
    ...
    CRegTestParams()
    {
        ...
        if (regenerate) {
            ...
            if (true && (genesis.GetHash() != hashGenesisBlock)) {
                ...
                std::cout << " hash: 0x" << genesis.GetHash().ToString().c_str();
                std::cout << " merklehash: 0x"  << genesis.hashMerkleRoot.ToString().c_str() <<  "\n";
                // Regtestnet --- nonce: 3 time: 1520801782 hash: 0x39a8ed422e0aa203a75748fbd8a3ad6fecf97d6265c680df11bb057581a58901 merklehash: 0xb111711ac77b7eaee69ec5142614c6381de336ea127977c94ba90335e0d93b41
            }
        } else {
            ...
            LogPrintf(" hash: 0x%s\n", genesis.GetHash().ToString().c_str());
            LogPrintf(" merklehash: 0x%s\n", genesis.hashMerkleRoot.ToString().c_str());
            assert(hashGenesisBlock == uint256("0x39a8ed422e0aa203a75748fbd8a3ad6fecf97d6265c680df11bb057581a58901"));
            assert(genesis.hashMerkleRoot == uint256("0xa7c47150f79b8c63543a5d361918b3f2d32861f4d1a93791c7d097990d175151"));
        }

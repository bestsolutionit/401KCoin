...
#   c) node1 mines 32 blocks, so now node 0 has 60001401k, node 1 has 4250401k, node2 has none.
#   d) node0 sends 601 401k to node2, in two transactions (301 401k, then 300 401k).

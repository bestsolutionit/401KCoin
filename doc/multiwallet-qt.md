...
Only requiring some minor changes is 401kcoin.cpp.
...
Changes to 401kcoin.cpp
----------------------
401kcoin.cpp is the entry point into 401kcoin-qt, and as such, will require some minor modifications to provide hooks for

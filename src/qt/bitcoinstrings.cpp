...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Disable all 401KCoin specific functionality (Masternodes, Zerocoin, SwiftX, "
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) %i The 401KCoin Core Developers"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of 401KCoin Core"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Fee (in 401K/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. 401KCoin Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart 401KCoin Core to complete"),

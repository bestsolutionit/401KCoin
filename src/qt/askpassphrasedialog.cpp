                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    // It doesn't make sense to show the checkbox for sending 401K because you wouldn't check it anyway.
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR 401K</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),

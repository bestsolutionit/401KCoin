 ...
 */
    ...
    typeWidget->addItem(tr("Received 401k from z401k"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in z401k"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_z401k));

...
#ifndef P401KCOIN_Z401KWALLET_H
#define P401KCOIN_Z401KWALLET_H
...
public:
    Cz401KWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZ401K(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZ401K(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //P401KCOIN_Z401KWALLET_H

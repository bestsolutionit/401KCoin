...
std::string HelpMessage(HelpMessageMode mode)
{
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "401kcoin.pid"));
#endif
    ...
    strUsage += HelpMessageOpt("-401kstake=<n>", strprintf(_("Enable or disable staking functionality for 401K inputs (0-1, default: %u)"), 1));
    strUsage += HelpMessageOpt("-z401kstake=<n>", strprintf(_("Enable or disable staking functionality for z401K inputs (0-1, default: %u)"), 1));
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) %i The 401KCoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        bool fEnableZPivBackups = GetBoolArg("-backupz401k", true);

...
*Setup instructions for a gitian build of 401K Coin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the 401K Coin
...
- [Building 401K Coin](#building-401kcoin)
...
To build 401K Coin (for Linux, OSX and Windows) just follow the steps under 'perform
...
For example:
```bash
URL=https://github.com/konez2k/401kcoin.git

...
bool OpenNetworkConnection(const CAddress& addrConnect, CSema401kcoinGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSema401kcoinGrant grantOutbound;

...
public:
    ...
    bool WriteZ401KSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZ401KSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZ401KSeed_deprecated(uint256& seed);
    bool EraseZ401KSeed();
    bool EraseZ401KSeed_deprecated();

    bool WriteZ401KCount(const uint32_t& nCount);
    bool ReadZ401KCount(uint32_t& nCount);

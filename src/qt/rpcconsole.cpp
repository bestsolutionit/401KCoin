                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strz401kPathCustom = GetArg("-z401kbackuppath", "");
    ...
    if(!strz401kPathCustom.empty()) {
        ui->wallet_customz401kbackuppath->setText(QString::fromStdString(strz401kPathCustom));
        ui->wallet_customz401kbackuppath_label->setVisible(true);
        ui->wallet_customz401kbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strz401kPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the 401KCoin RPC console.") + "<br>" +

...
/** 
    ...
    ****Note - for 401KCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of 401kcoin coming in to a transaction

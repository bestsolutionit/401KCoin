...
pkgdatadir = $(datadir)/401kcoin
pkgincludedir = $(includedir)/401kcoin
pkglibdir = $(libdir)/401kcoin
pkglibexecdir = $(libexecdir)/401kcoin
...
ACLOCAL = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = 401kcoin-cli
BITCOIN_DAEMON_NAME = 401kcoind
...
MAINT = 
MAKEINFO = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/osboxes/blockchain/401KCoin
abs_srcdir = /home/osboxes/blockchain/401KCoin
abs_top_builddir = /home/osboxes/blockchain/401KCoin
abs_top_srcdir = /home/osboxes/blockchain/401KCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/osboxes/blockchain/401KCoin/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_401kcoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_401kcoin_coverage.info test_401kcoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/401KCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/401kcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/401kcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/401kcoin-config.h
$(top_srcdir)/src/config/401kcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/401kcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/401KCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/401KCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/401KCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_401kcoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_401kcoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_401kcoin_filtered.info: test_401kcoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_401kcoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_401kcoin_coverage.info: baseline_filtered_combined.info test_401kcoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_401kcoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_401kcoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_401kcoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_401kcoin.coverage/.dirstamp:  test_401kcoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_401kcoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_401kcoin.coverage/ total.coverage/ $(OSX_APP)

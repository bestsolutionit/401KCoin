...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure 401KCoin with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the 401KCoin wallet:
...
You have the choice to build the GUI 401KCoin wallet as a Mac OSX app, described in “How to build the 401KCoin-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the 401KCoin-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find 401KCoin-Qt.dmg inside your 401KCoin folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/401KCoin/src/qt/401kcoin-qt